    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo base_url() ?>constancia/index">Constancia</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
        <div class="container" style="padding-top: 150px">
            <div class="text-center">
                ...
                <a class="btn btn-primary btn-lg" href="<?php base_url() ?>constancia/create_constancia" target="_blank">
                    <i class="fa fa-file-pdf-o"></i> Generar constancias
                </a>
            </div>
        </div>
    </body>
